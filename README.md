...
1.  [基础类型·any.联合类型.数组·元组](basic-types.ts)   
2.  [interface接口](interface.ts)   
...
1. [NiceFish]( https://gitee.com/mumu-osc/NiceFish)：美人鱼，这是一个微型Blog系统，前端基于Angular7.0 + PrimeNG7.1.0。（GVIP 码云最有价值的开源项目 4404 ☆)
